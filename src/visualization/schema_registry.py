...
ROLES: dict[str, SemanticRole] = {
    ...
    "participant.health_literacy": _role("participant.health_literacy", "participants", False, "number", "Health Literacy", ("bhls_health_literacy", "health_literacy")),
    "participant.social_support": _role("participant.social_support", "participants", False, "number", "Social Support", ("mspss_social_support", "social_support")),
    "participant.depression": _role("participant.depression", "participants", False, "number", "Depression Score", ("epds_depression", "depression")),
    "participant.anxiety": _role("participant.anxiety", "participants", False, "number", "Anxiety Score", ("pass_anxiety", "anxiety")),
    ...
    "vital.respiratory_rate": _role("vital.respiratory_rate", "daily_vitals", False, "number", "Respiratory Rate", ("rr_mean", "respiratory_rate"), "breaths/min"),
    "vital.skin_temperature_c": _role("vital.skin_temperature_c", "daily_vitals", False, "number", "Skin Temperature", ("skin_temp_mean_c", "temperature_c", "skin_temperature_c"), "C"),
    ...
    "vital.weight_kg": _role("vital.weight_kg", "daily_vitals", False, "number", "Weight", ("weight_kg",), "kg"),
    "vital.body_water_pct": _role("vital.body_water_pct", "daily_vitals", False, "number", "Body Water", ("body_water_pct",), "%"),
    "vital.sleep_hours": _role("vital.sleep_hours", "daily_vitals", False, "number", "Sleep", ("sleep_hours",), "hours"),
    "vital.steps": _role("vital.steps", "daily_vitals", False, "number", "Steps", ("steps",), "steps"),
    "vital.active_minutes": _role("vital.active_minutes", "daily_vitals", False, "number", "Active Minutes", ("active_minutes",), "minutes"),
    "vital.scale_used": _role("vital.scale_used", "daily_vitals", False, "boolean", "Scale Used", ("scale_used", "scale_adherence")),
    ...
    "contact.id": _role("contact.id", "staff_contacts", False, "string", "Contact ID", ("contact_id",)),
    ...
    "contact.completed": _role("contact.completed", "staff_contacts", False, "boolean", "Contact Completed", ("participant_reached", "contact_method", "completed")),
    ...
    "outcome.heat_illness": _role("outcome.heat_illness", "clinical_outcomes", False, "number", "Heat Illness Episodes", ("heat_illness_episodes", "heat_illness")),
    "environment.date": _role("environment.date", "environment", True, "date", "Date", ("date",)),
    "environment.study_day": _role("environment.study_day", "environment", True, "number", "Study Day", ("study_day",)),
    "environment.ambient_temp_c": _role("environment.ambient_temp_c", "environment", True, "number", "Ambient Temperature", ("ambient_temp_c",), "C"),
    "environment.heat_index_c": _role("environment.heat_index_c", "environment", True, "number", "Heat Index", ("heat_index_c",), "C"),
    "environment.heat_wave": _role("environment.heat_wave", "environment", False, "boolean", "Heat Wave", ("heat_wave",)),
    "environment.heat_exposure_level": _role("environment.heat_exposure_level", "environment", False, "category", "Heat Exposure", ("heat_exposure_level",), categories=("low", "moderate", "high", "extreme")),
    "recruitment.participant_id": _role("recruitment.participant_id", "recruitment", True, "string", "Participant ID", ("participant_id",)),
    "recruitment.date": _role("recruitment.date", "recruitment", False, "date", "Recruitment Date", ("recruitment_date",)),
    "recruitment.source": _role("recruitment.source", "recruitment", False, "category", "Recruitment Source", ("recruitment_source",)),
    "recruitment.eligible": _role("recruitment.eligible", "recruitment", False, "boolean", "Eligible", ("eligible",)),
    "recruitment.enrolled": _role("recruitment.enrolled", "recruitment", False, "boolean", "Enrolled", ("enrolled",)),
    "recruitment.decline_reason": _role("recruitment.decline_reason", "recruitment", False, "string", "Decline Reason", ("decline_reason",)),
}
...
ENTITIES: dict[str, EntitySpec] = {
    ...
    "environment": EntitySpec(
        name="environment",
        status="future_optional",
        source_filenames=("environment.csv",),
        primary_key_roles=("environment.date", "environment.study_day"),
        participant_role=None,
        datetime_roles=("environment.date",),
        required_roles=("environment.date", "environment.study_day", "environment.ambient_temp_c", "environment.heat_index_c"),
        optional_roles=("environment.heat_wave", "environment.heat_exposure_level"),
        default_aggregation="calendar_day",
    ),
    "recruitment": EntitySpec(
        name="recruitment",
        status="future_optional",
        source_filenames=("recruitment.csv",),
        primary_key_roles=("recruitment.participant_id",),
        participant_role="recruitment.participant_id",
        datetime_roles=("recruitment.date",),
        required_roles=("recruitment.participant_id",),
        optional_roles=(
            "recruitment.date",
            "recruitment.source",
            "recruitment.eligible",
            "recruitment.enrolled",
            "recruitment.decline_reason",
        ),
        default_aggregation="participant",
    ),
